...
Now extended with REST API endpoints for JSON access.

\---

## Features

* Add new students via form (`add\_student.html`)
* Edit existing students (`edit\_student.html`)
...
!\[Add Student](images/add\_student.png)

### Edit Student Form

!\[Edit Student](images/edit\_student.png)
